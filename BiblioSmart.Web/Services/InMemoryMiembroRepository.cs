...
namespace BiblioSmart.Web.Services
{
    public class InMemoryMiembroRepository : IMiembroRepository
    {
        ...
        {
            new Miembro { Id = 1, NombreCompleto = "Sheyssi Puente Adames", Cedula = "001-0000000-1", Correo = "sheyssi@bibliosmart.local", Telefono = "809-555-0001", FechaRegistro = DateTime.Now },
            new Miembro { Id = 2, NombreCompleto = "Maria Garcia", Cedula = "002-1234567-8", Correo = "maria@bibliosmart.local", Telefono = "809-555-0002", FechaRegistro = DateTime.Now },
        };
